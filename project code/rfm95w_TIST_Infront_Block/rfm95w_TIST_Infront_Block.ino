...
void readPMS7003()
{
 ...
 pms.read();                   // read the PM sensor
  Serial.print(F("PM1.0 "));Serial.println(pms.pm01);//Serial.print(F(", "));
  Serial.print(F("PM2.5 "));Serial.println(pms.pm25);//Serial.print(F(", "));
  Serial.print(F("PM10 ")) ;Serial.println(pms.pm10);//Serial.println(F(" [ug/m3]"));
  mydata.PM1=pms.pm01;
